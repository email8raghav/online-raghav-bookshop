...
public class UserShipping implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 685095944711032707L;
	...
	/*
	 * Many user shipping for a single userEntity and that is good.
	 * 
	 * one user can have many shipping address like mine as Delhi and Ballia
	 * 
	 * Today i have selected in PathInfoTech
	 */
